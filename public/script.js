  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, errorType) {
      const label = field.closest('[class*="field"], [class*="group"], label, div')
        ?.querySelector('label')?.textContent?.trim() || field.name || field.placeholder || 'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '068de0cc-c24f-4c4f-b10e-fd5f6087f774',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '068de0cc-c24f-4c4f-b10e-fd5f6087f774';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '068de0cc-c24f-4c4f-b10e-fd5f6087f774';
